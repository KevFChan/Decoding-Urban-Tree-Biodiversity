#This .py file will execute the preprocessing and processing scripts on the remote sensing data for a city
...
if __name__ == "__main__":
    ...
    for num_city in range(len(cities)):
        ...
        #Step 9: Run image fusion on the Landsat_ARD and MODIS data and perform cuFSDAF
        #Try applying OBSUM and one other
        # step_nine_executable_path = r"/mnt/d/SetoLab/code/Archive/cuFSDAF-master/Code/cuFSDAF"
        # step_nine_template_path = r"/mnt/d/SetoLab/code/Archive/cuFSDAF-master/Code/Parameters_template.txt"
        # step_nine_parameter_directory = r"/mnt/d/SetoLab/code/Archive/cuFSDAF-master/Code/parameter_HLS_MODIS"
        ...
        step_nine_path_MODIS = step_eight_output

        #We need to apply the segmentation code
        
        
        step_nine_output = os.path.join(data_output_dir, "Step_Nine_Spatiotemporal_Fused", city)
        print(f"Running cuFSDAF image fusion code on MODIS and landsat data for {city}")
        run_script('pro_4_image_fusion_par_SDC_full_city.py', script_working_dir, ["--executable_path", step_nine_executable_path,
                                                                "--template_path", step_nine_template_path,
                                                                "--parameter_directory", step_nine_parameter_directory,
                                                                "--path_class", step_nine_path_class,
                                                                "--path_landsat", step_nine_path_landsat,
